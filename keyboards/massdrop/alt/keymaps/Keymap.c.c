...
led_instruction_t led_instructions_mine[] = {  //Blue and White
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB | LED_FLAG_USE_GLITTER,            .layer = 0, .id0 = 335478784,  .id1 = 16770591,   .r = 51, .g = 252,  .b = 255}, //Blue
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB,                                   .layer = 0, .id0 = 2147483648, .id1 = 487,        .r = 255,   .g = 255, .b = 255},  // ASDFJKL: White
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB | LED_FLAG_USE_GLITTER,            .layer = 0, .id0 = 201326592,                     .r = 255, .g = 255, .b = 255},  // [] White
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_NULL ,                                     .layer = 0, .id2 = 262136}, //null off
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_ROTATE_PATTERN,                        .layer = 0, .id0 = 32767}, //esc-del top row pattern with no glitter
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_ROTATE_PATTERN | LED_FLAG_USE_GLITTER, .layer = 0, .id0 = 1610645504, .id1 = 4278196224, .id2 = 4294705159, .id3 = 511},
...
led_instruction_t led_game_instructions_mine[] = {   //Blue, White and Purple
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB,             .layer = 0, .id0 = 2147614720, .id1 = 3,      .r = 51,   .g = 252, .b = 255},  //WASD Blue
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB,             .layer = 0, .id1 = 524288,                    .r = 214,   .g = 61, .b = 245},  //M Purple
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB,             .layer = 0, .id0 = 32798, .id1 = 335548416,   .r = 255, .g = 255, .b = 255},  // 1234,tab,shift,ctrl,alt White
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB,             .layer = 0, .id0 = 1572864, .id1 = 1036,        .r = 52,  .g = 83,  .b = 83},  //rt dark/dim white
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB,             .layer = 0, .id0 = 327680, .id1 = 57344,      .r = 214,   .g = 61, .b = 245},  //QEZXC Purple
    {.flags = LED_FLAG_MATCH_LAYER | LED_FLAG_MATCH_ID | LED_FLAG_NULL,                .layer = 0, .id0 = 1071677408, .id1 = 200739824, .id2 = 262136}, //null off
